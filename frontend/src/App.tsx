 ...
 * Replaced with more defined shapes using paths extracted from the provided example.
 */
...
<svg width="80" height="60" viewBox="0 0 442.48889 415.55103" xmlns="http://www.w3.org/2000/svg">
  <path fill="lightblue" stroke="#333" stroke-width="2"
    ...
    default: '<svg width="80" height="60"></svg>'
  };
  return svgs[region] || svgs.default;
}
...
const App: React.FC = () => {
  ...
  // For region determination
  const [isGeoChecked, setIsGeoChecked] = useState<boolean>(false);
